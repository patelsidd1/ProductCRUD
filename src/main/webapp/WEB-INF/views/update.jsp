...
<h1 class="text-center mb-3 fancy-heading">Update <span class="highlight">Product Details </span></h1>
        ...
        font-weight: bold;
            ...
            <input type="hidden" value="${product.id}" name="id" />
                ...
                <div class="form-group">
                    ...
                    rows="5" placeholder="Enter the product Discription">${product.description}
                    </textarea>
